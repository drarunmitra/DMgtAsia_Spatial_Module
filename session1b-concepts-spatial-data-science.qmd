...
format:
  html:
    toc: true
  revealjs:
    output-file: slides-session1b-concepts-spatial-data-science.html
...
other-links:
  - text: "View as slides"
    href: slides-session1b-concepts-spatial-data-science.html
    icon: easel2
---
...
## Applications of GIS in Public Health (cont.)
...
## Why Spatial Data Science for Public Health? (cont.)
